...
const WORDS = ["MERN Stack Developer", "Full Stack Developer", "Web Innovator"];
const TECH_STACK = [
  "React.js",
  "Node.js",
  "Express.js",
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/BharathA26" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/bharath-anandhan" },
  { icon: Mail, link: "mailto:bharathanadhan@gmail.com" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  I craft innovative, scalable, and user-friendly web applications
                  using the MERN Stack and modern technologies. Let's build
                  solutions that drive impact and growth.
                </p>
                ...
                >
                  <CTAButton
                    ...
                    icon={ExternalLink}
                  />
                  <CTAButton href="#Contact" text="Get in Touch" icon={Mail} />
                </div>
