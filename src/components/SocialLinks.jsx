...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/bharath-anandhan",
    color: "#0A66C2",
  ...
  },
  {
    name: "Email",
    displayName: "Email",
    subText: "bharathanadhan@gmail.com",
    icon: Mail,
    url: "mailto:bharathanadhan@gmail.com",
    color: "#EA4335",
  ...
  },
  {
    ...
    subText: "@BharathA26",
    icon: Github,
    url: "https://github.com/BharathA26",
    color: "#ffffff",
